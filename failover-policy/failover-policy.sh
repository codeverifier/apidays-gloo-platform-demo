...
Provision() {
    ...
    kubectl --context ${MGMT_CONTEXT} apply -f $DIR/backend-apis-team/reviews-failover-policy.yaml
    kubectl --context ${MGMT_CONTEXT} apply -f $DIR/backend-apis-team/reviews-outlier-detection.yaml
}
...
Delete() {
    ...
    kubectl --context ${MGMT_CONTEXT} delete -f $DIR/backend-apis-team/reviews-failover-policy.yaml
    kubectl --context ${MGMT_CONTEXT} delete -f $DIR/backend-apis-team/reviews-outlier-detection.yaml
}
