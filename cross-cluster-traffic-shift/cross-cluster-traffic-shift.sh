...
Provision() {
    ...
    kubectl --context ${MGMT_CONTEXT} apply -f $DIR/backend-apis-team/reviews-v3-route-table.yaml
    envsubst < <(cat $DIR/backend-apis-team/reviews-v3-virtual-destination.yaml) | kubectl --context ${MGMT_CONTEXT} apply -f -
}
...
Delete() {
    ...
    kubectl --context ${MGMT_CONTEXT} delete -f $DIR/backend-apis-team/reviews-v3-route-table.yaml
    envsubst < <(cat $DIR/backend-apis-team/reviews-v3-virtual-destination.yaml) | kubectl --context ${MGMT_CONTEXT} delete -f -
}
