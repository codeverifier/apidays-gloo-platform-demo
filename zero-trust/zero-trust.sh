...
Provision() {
    echo "------------------------------------------------------------"
    echo "Injecting zero trust policies"
    echo "Note: Demonstrates the Workspace feature which helps to establish service isolation boundaries. 
    echo "Here the "backend team" who owns 'backend-apis-team' workspace has taken a stance on who can be trusted."
    echo "They have not allowed any service out of the workspace to access their APIs"
    echo "------------------------------------------------------------"
    echo ""
